const Highlights = () => {
  ...
  return (
    <section
      id="highlights"
      className="min-h-screen w-full bg-rose-50 py-16 sm:py-24"
    >
      <div className="mx-auto max-w-myapp px-4 sm:px-10">
        ...
        <p className="font-inter mx-auto mt-6 max-w-2xl text-center text-sm text-gray-700 sm:text-base">
          We're more than just flowers — we offer a full experience of elegance, convenience, and care.
        </p>
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {items.map(({ icon, title, text }) => (
            ...
            >
              ...
              <h3 className="font-inter mt-4 text-lg font-semibold text-subColor">
                {title}
              </h3>
